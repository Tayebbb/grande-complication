...
export const CAMERA_KEYS: CameraKey[] = [
  { p: 0.0, az: 14, el: 30, dist: 15.6, target: [0, -2.0, 0.1] },
  { p: 0.02, az: 14, el: 30, dist: 15.6, target: [0, -2.0, 0.1] }, // dead-stop landing on reverse
  { p: 0.1, az: 10, el: 24, dist: 14.6, target: [0, -1.7, 0.2] },
...
export const DOSSIER: DossierStop[] = [
  ...
  },
  {
    ...
    anchor: [0, 4.4, 2.75], az: 26, el: 6, dist: 5.6,
